...
abstract class Company extends Model
{
    ...
    {
        return $this->belongsTo(Context::userModel(), 'user_id');
    }
    ...
    {
        return $this->belongsToMany(Context::userModel(), Context::employeeshipModel())
                        ->withPivot('role')
                        ->withTimestamps()
                        ->as('employeeship');
    }
    ...
    {
        return $this->hasMany(Context::companyInvitationModel());
    }
