...
class ApiTokenManager extends Component
{
    ...
    {
        $this->createApiTokenForm['permissions'] = Context::$defaultPermissions;
    }
    ...
    public function createApiToken()
    {
        ...
        $this->displayTokenValue($this->user->createToken(
            ...
            Context::validPermissions($this->createApiTokenForm['permissions'])
        ));
    ...
    public function updateApiToken()
    {
        $this->managingPermissionsFor->forceFill([
            'abilities' => Context::validPermissions($this->updateApiTokenForm['permissions']),
        ])->save();
