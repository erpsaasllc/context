...
namespace ERPSAAS\Context\Console;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'context:install {stack : The development stack that should be installed (filament)}
     ...
     * @var string
     */
    protected $description = 'Install the Context components and resources';
    ...
    public function handle()
    {
        ...
        // Publish...
        $this->callSilent('vendor:publish', ['--tag' => 'context-config', '--force' => true]);
        $this->callSilent('vendor:publish', ['--tag' => 'context-migrations', '--force' => true]);
    ...
    protected function installFilamentStack()
    {
        ...
        // Service Providers...
        copy(__DIR__.'/../../stubs/app/Providers/ContextServiceProvider.php', app_path('Providers/ContextServiceProvider.php'));
        $this->installServiceProviderAfter('FortifyServiceProvider', 'ContextServiceProvider');
        ...
        copy(__DIR__.'/../../stubs/app/Actions/Context/DeleteUser.php', app_path('Actions/Context/DeleteUser.php'));
...
EOF;
    ...
    protected function ensureApplicationIsCompanyCompatible()
    {
        ...
        copy(__DIR__.'/../../stubs/app/Providers/ContextWithCompaniesServiceProvider.php', app_path('Providers/ContextServiceProvider.php'));
        ...
        // Actions...
        copy(__DIR__.'/../../stubs/app/Actions/Context/AddCompanyEmployee.php', app_path('Actions/Context/AddCompanyEmployee.php'));
        copy(__DIR__.'/../../stubs/app/Actions/Context/CreateCompany.php', app_path('Actions/Context/CreateCompany.php'));
        copy(__DIR__.'/../../stubs/app/Actions/Context/DeleteCompany.php', app_path('Actions/Context/DeleteCompany.php'));
        copy(__DIR__.'/../../stubs/app/Actions/Context/DeleteUserWithCompanies.php', app_path('Actions/Context/DeleteUser.php'));
        copy(__DIR__.'/../../stubs/app/Actions/Context/InviteCompanyEmployee.php', app_path('Actions/Context/InviteCompanyEmployee.php'));
        copy(__DIR__.'/../../stubs/app/Actions/Context/RemoveCompanyEmployee.php', app_path('Actions/Context/RemoveCompanyEmployee.php'));
