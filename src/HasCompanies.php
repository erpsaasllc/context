...
trait HasCompanies
{
    ...
    public function currentCompany()
    {
        ...
        return $this->belongsTo(Context::companyModel(), 'current_company_id');
    }
    ...
    {
        return $this->hasMany(Context::companyModel());
    }
    ...
    {
        return $this->belongsToMany(Context::companyModel(), Context::employeeshipModel())
                        ->withPivot('role')
                        ->withTimestamps()
                        ->as('employeeship');
    }
     ...
     *
     * @param  mixed  $company
     * @return \ERPSAAS\Context\Role|null
     */
    public function companyRole($company)
    {
        ...
        return $role ? Context::findRole($role) : null;
    }
    ...
    public function hasCompanyRole($company, string $role)
    {
        ...
        return $this->belongsToCompany($company) && optional(Context::findRole($company->users->where(
            'id', $this->id
